...
ElevatorCommandTele::ElevatorCommandTele() {
    ...
    liftA = new VictorSP(INTAKE_CUBE_MOTOR_A);
    liftB = new VictorSP(INTAKE_CUBE_MOTOR_B);

    encoderElevator = new Encoder(ENCODER_LIFT_A, ENCODER_LIFT_B, false, frc::Encoder::k1X);
